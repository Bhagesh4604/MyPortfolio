  ...
  return (
    <section id="home" className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        <a href="https://www.linkedin.com/in/bhagesh-biradar-885996260/" target="_blank" className="px-10 py-4 bg-transparent border border-white/10 text-white rounded-xl font-black transition-all hover:bg-white/5 flex items-center gap-2 cursor-none">
